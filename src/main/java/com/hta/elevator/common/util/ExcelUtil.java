package com.hta.elevator.common.util;
...
import com.hta.elevator.common.annotaion.Excel.Type;
import com.hta.elevator.common.bean.Code;
import com.hta.elevator.common.bean.Response;
import com.hta.elevator.common.util.spring.GlobalConfig;
import com.hta.elevator.common.util.spring.SpringUtils;
...
public class ExcelUtil<T>
{
    ...
    public Response exportExcel()
    {
        ...
        try
        {
            ...
            wb.write(out);
            return new Response().Success(Code.EXCEL_LEAD_OUT_SUCCESS,Code.EXCEL_LEAD_OUT_SUCCESS.getMsg()).addData("filename", filename);
        }
        catch (Exception e)
        {
            log.error("导出Excel异常{}", e.getMessage());
            return new Response().Success(Code.EXCEL_LEAD_OUT_FAIL,Code.EXCEL_LEAD_OUT_FAIL.getMsg());
        }
        finally
        {
            if (wb != null)
    ...
    {
    	GlobalConfig globalConfig = SpringUtils.getBean("globalConfig");
        String downloadPath = globalConfig.getDownloadUrl() + filename;
