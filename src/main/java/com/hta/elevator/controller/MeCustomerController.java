 ...
 */
@Controller
@Api(tags = "	ME_Customer 操作")
@RequestMapping("/elevator/meCustomer")
public class MeCustomerController extends BaseController<MeCustomer> 
{
	
	@Autowired
	private MeCustomerService meCustomerService;
