...
@Controller
@Api(tags = "订阅 操作")
@RequestMapping("/elevator/govSubscribe")
public class GovSubscribeController extends BaseController<GovSubscribe> 
{
	
	@Autowired
	private GovSubscribeService govSubscribeService;
