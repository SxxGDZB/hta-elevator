 ...
 */
@Controller
@Api(tags = "	MaintHistory	 操作")
@RequestMapping("/elevator/maintHistory")
public class MaintHistoryController extends BaseController<MaintHistory> 
{
	
	@Autowired
	private MaintHistoryService maintHistoryService;
