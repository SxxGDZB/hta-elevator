 ...
 */
@Controller
@Api(tags = "	ME_License	 操作")
@RequestMapping("/elevator/meLicense")
public class MeLicenseController extends BaseController<MeLicense> 
{
	
	@Autowired
	private MeLicenseService meLicenseService;
