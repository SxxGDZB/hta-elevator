 ...
 */
@Controller
@Api(tags = "	SmsAlarmUser	 操作")
@RequestMapping("/elevator/smsAlarmUser")
public class SmsAlarmUserController extends BaseController<SmsAlarmUser> 
{
	
	@Autowired
	private SmsAlarmUserService smsAlarmUserService;
