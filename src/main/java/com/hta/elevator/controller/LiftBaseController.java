 ...
 */
@Controller
@Api(tags = "	LiftBase	 操作")
@RequestMapping("/elevator/liftBase")
public class LiftBaseController extends BaseController<LiftBase> 
{
	
	@Autowired
	private LiftBaseService liftBaseService;
