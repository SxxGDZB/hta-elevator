 ...
 */
@Controller
@Api(tags = "	ME_CpuLog	 操作")
@RequestMapping("/elevator/meCpulog")
public class MeCpulogController extends BaseController<MeCpulog> 
{
	
	@Autowired
	private MeCpulogService meCpulogService;
